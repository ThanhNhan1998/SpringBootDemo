...
public class TokenProvider implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2387601802363396592L;
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + SystemConstant.ACCESS_TOKEN_VALIDITY_MILISECONDS))
                .compact();
    }
